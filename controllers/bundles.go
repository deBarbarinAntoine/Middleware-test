...
var LoginHandlerGetBundle = middlewares.Join(loginHandlerGet, middlewares.Log)
var LoginHandlerPostBundle = middlewares.Join(loginHandlerPost, middlewares.Log)
var RegisterHandlerGetBundle = middlewares.Join(registerHandlerGet, middlewares.Log)
var RegisterHandlerPostBundle = middlewares.Join(registerHandlerPost, middlewares.Log)
